...
UK-Accidents_2016_Analysis is a data analysis project that focuses on exploring and cleaning a dataset of UK road accidents in 2016. The project involves using various data analysis tools such as airflow and docker to load and transform the dataset, as well as visualising and answering questions related to the data. 

The project also involves data cleaning techniques such as handling missing data, removing duplicates, and detecting outliers. In addition, the project involves data transformation and feature engineering, such as adding new columns, encoding categorical features, and normalising certain features.

The project emphasizes the importance of creating generic and flexible code that can work with various datasets, and requires documenting any imputations or encodings made to the data.

## Project Steps

1. Load dataset 
2. Explore the dataset and ask at least 5 questions to give you a better understanding of the data provided to you.
3. Visualise the answer to these 5 questions.
4. Cleaning the data: 
   - Observe missing data and comment on why you believe it is missing (MCAR, MAR or MNAR)
   - Observe duplicate data
   - Observe outliers
   - Handle any unclean data
   - Comment on why you used each technique and how it affected the data.
5. Data transformation and feature engineering:
   - Add a new column named 'Week number' and discretize the data into weeks according to the dates. Change the datatype of the date feature to datetime type instead of object.
   - Encode any categorical feature(s) and comment on why you used this technique and how the data has changed.
   - Identify feature(s) which need normalisation and show your reasoning. Choose a technique to normalise the feature(s) and comment on why you chose this technique.
   - Add at least two more columns which adds more info to the dataset by evaluating specific feature(s). E.g. a column indicating whether the accident was on a weekend or not.
   - Document any imputations or encodings made to the data in a new csv file.
6. Load the new dataset into a csv file.
7. Load the dataset as a parquet file instead of a csv file (Parquet file is a compressed file format).
